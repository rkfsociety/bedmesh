...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.path = ui_elements_win.LabeledEntry(self.sidebar, strings_win.LBL_PATH, self.settings.get("path", ""))
        ctk.CTkButton(self.sidebar, text=strings_win.BTN_FETCH, command=self.fetch).pack(pady=10, padx=20)
        ...
        self.t2d, self.traw = self.tabs.add(strings_win.TAB_2D), self.tabs.add(strings_win.TAB_RAW)

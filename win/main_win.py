...
class App(ctk.CTk):
    ...
    def init_ui(self):
        ...
        self.analysis = AnalysisPanel(self, self.settings.get("z_sys", "Anycubic"), self.settings.get("pitch", "0.7"), self.refresh_recs)
    ...
    def save_cfg(self):
        ...
        try:
            ...
            self.cfg_content = text; messagebox.showinfo("Успех", "Принтер обновлен!")
    ...
    def run(self):
        ...
        if self.matrix is not None:
            ...
            save_dict = d.copy(); save_dict.update({"z_sys": self.analysis.z_m.get(), "pitch": self.analysis.p_m.get()})
    ...
    def on_closing(self): self.destroy(); sys.exit(0)

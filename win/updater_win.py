        ...
        try:
            ...
            if r.status_code == 200:
                ...
                if latest_v_num > current_v_num:
                    ...
                    has_win_asset = any(a["name"].endswith(".exe") for a in assets)
                    if has_win_asset:
...
def install_update(data):
    try:
        ...
        messagebox.showinfo("Update", "Обновление для Windows скачано. Перезапуск...")
        subprocess.Popen("updater_win.bat", shell=True)
        os._exit(0)
